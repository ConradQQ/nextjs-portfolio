     ...
     <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
      <div className='col-span-2'>
       ...
       <p className='py-2 text-gray-600'>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed ab voluptates, qui, reiciendis libero vel esse pariatur soluta temporibus quisquam quibusdam. Ad quae suscipit voluptas sit nihil, facilis debitis aut!
        </p>
       <p className='py-2 text-gray-600'>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed ab voluptates, qui, reiciendis libero vel esse pariatur soluta temporibus quisquam quibusdam. Ad quae suscipit voluptas sit nihil, facilis debitis aut!
        </p>
